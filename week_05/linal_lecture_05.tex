...
% 37 черточки +
% 38  +
% 43 и 44 переставить выше надпись про замену +
% 71 - 74 матрицы 
% 86 87 88 знак +
% 104 105 106 запятая +
% 130-132 вместо p нужно k
...
\input{chapters/lec_050_fra_010_qform.tex} % долго рендерится из-за 3d графиков!
...
\input{chapters/lec_050_fra_030_qform_eigenvalues.tex}

\input{chapters/lec_050_fra_040_sylvester.tex}
...
\input{chapters/lec_040_fra_060_gramm.tex}
