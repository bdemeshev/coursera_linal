...
\begin{block}{Рабочее определение:}
  Вектор — столбец из нескольких чисел.   
\end{block}
...
\uncover<1->{
\begin{block}{Скалярное произведение векторов $a$ и $b$:}
  $\langle a, b \rangle = a_1 b_1 + a_2 b_2 + \ldots + a_n b_n$.
\end{block}
}

\uncover<2->{
\begin{block}{Косинус угла между векторами $a$ и $b$:}
